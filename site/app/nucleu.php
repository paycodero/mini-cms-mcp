...
function csp_pagina(string $nonce, array $extra = []): string
{
    ...
    // Măsurarea (GA4) își aduce singură sursele de care are nevoie, și numai dacă e pornită. Fără ea, nimic în plus.
    if ((string) config('site.ga4') !== '') {
